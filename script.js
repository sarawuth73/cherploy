...
const imageData = [
    // Images
    { src: "./img/cherploy/1.png", caption: "ฮั่นแน่.....", type: "image" },
    { src: "./img/cherploy/2.png", caption: "อาหมวยโดนแกล้ง5555555", type: "image" },
    { src: "./img/cherploy/3.png", caption: "เหม่ง", type: "image" },
    { src: "./img/cherploy/4.png", caption: "คิมิโนโตะ", type: "image" },
    { src: "./img/cherploy/5.png", caption: "อุ๊บ!.....", type: "image" },
    { src: "./img/cherploy/6.png", caption: "ยิ้มมมม", type: "image" },
    { src: "./img/cherploy/8.jpg", caption: "น่ารัก", type: "image" },
      { src: "./img/cherploy/9.jpg", caption: "บึ้มมมมมม", type: "image" },
     { src: "./img/cherploy/7.png", caption: "ขาวยันผม", type: "image" },
    { src: "./img/cherploy/10.jpg", caption: "หม่ำๆ เด้ออ้าย", type: "image" },
    { src: "./img/cherploy/11.jpg", caption: "มองบน", type: "image" },
    { src: "./img/cherploy/12.jpg", caption: "กินคนเดียวเปรี้ยวทั้งไลฟ์", type: "image" },
    { src: "./img/cherploy/13.jpg", caption: "เด็กหนวด", type: "image" },
    { src: "./img/cherploy/14.jpg", caption: "เห้อออ", type: "image" },
    { src: "./img/cherploy/17.jpg", caption: "รึจะเอา", type: "image" },
    { src: "./img/cherploy/15.jpg", caption: "หนูขาวไหมคะ", type: "image" },
    { src: "./img/cherploy/16.jpg", caption: "หนูขาวยังคะ", type: "image" },
    { src: "./img/cherploy/18.jpg", caption: "ยิ้มมมมม", type: "image" },
    { src: "./img/cherploy/22.jpg", caption: "หน้าขาวคู่", type: "image" },
    { src: "./img/cherploy/23.jpg", caption: "ชู่ววววววว", type: "image" },
    { src: "./img/cherploy/24.jpg", caption: "ยิ้มมมม", type: "image" },
    { src: "./img/cherploy/25.jpg", caption: "ยิ้มมมม", type: "image" },
    { src: "./img/cherploy/26.jpg", caption: "ยิ้มมมม", type: "image" },
    { src: "./img/cherploy/27.jpg", caption: "หลับบบ....", type: "image" },
    { src: "./img/cherploy/28.jpg", caption: "ปากจู้วววววววววว", type: "image" },
    { src: "./img/cherploy/29.jpg", caption: "หืมมมมมมมมมมม", type: "image" },
    { src: "./img/cherploy/30.jpg", caption: "กระต่ายหัวเหม่ง", type: "image" },
    { src: "./img/cherploy/31.jpg", caption: "ฝาแฝด", type: "image" },
    { src: "./img/cherploy/32.jpg", caption: "อวยพรวันเกิดด", type: "image" },
    { src: "./img/cherploy/33.jpg", caption: "ลาบูแคระ", type: "image" },
      { src: "./img/cherploy/34.mov", caption: "เจอแบบนี้อยากจะสารบาป", type: "video" },
    { src: "./img/cherploy/35.jpg", caption: "ชุดนักเรียนญี่ปุ่น+หูแมว", type: "image" },
    { src: "./img/cherploy/36.jpg", caption: "น้องเมดแคระ", type: "image" },
    { src: "./img/cherploy/37.jpg", caption: "ไททั่นแคระ", type: "image" },
    { src: "./img/cherploy/38.mp4", caption: "ตี1ที่คูเมือง BY ชิสุแคระ", type: "video" },

    { src: "./img/cherploy/39.jpg", caption: "อวดกระเป๋า", type: "image" },
    { src: "./img/cherploy/40.jpg", caption: "ชูสองนิ้ว", type: "image" },
    { src: "./img/cherploy/42.mov", caption: "Pandora", type: "video" },

    { src: "./img/cherploy/43.jpg", caption: "pandora สวยมากกกกกกกก", type: "image" },
    { src: "./img/cherploy/44.jpg", caption: "งื้ออออออออออออออออ", type: "image" },
    { src: "./img/cherploy/45.jpg", caption: "หนาววววว", type: "image" },
    { src: "./img/cherploy/46.jpg", caption: "ของขวัญวันเกิดชิ้นที่2และ3", type: "image" },
...
let game3Data = {
    ...
    usedNumbers: [],
    allPlayers: [
        { name: "หมูแคระ", isBot: false, choice: null, score: 10, alive: true },
